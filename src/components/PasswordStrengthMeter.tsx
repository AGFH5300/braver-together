...
const STRENGTH_LEVELS = [
  { label: "Very Weak", barClass: "bg-red-700", textClass: "text-red-700" },
  { label: "Weak", barClass: "bg-orange-600", textClass: "text-orange-700" },
  { label: "Okay", barClass: "bg-yellow-500", textClass: "text-yellow-700" },
  { label: "Solid", barClass: "bg-green-600", textClass: "text-green-700" },
  { label: "Godly", barClass: "bg-purple-700", textClass: "text-purple-700" },
] as const;
